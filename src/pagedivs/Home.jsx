...
export default function Home() {
    ...
    return (
        <div className={styles.homeMain}>
            ...
            <p className={styles.homeFlavorText2} >Click the big white and blue planet (the one that says "Start Here!") to get started. (Feel free to drag around and zoom in and out, it's interactive).</p>
        </div>
    )
}